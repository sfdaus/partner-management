...
func main() {
	...
	partnerRepo := pgsqlRepository.NewPgsqlPartnerRepository(dbInstance)
	...
	partnerUC := usecase.NewPartnerUsecase(partnerRepo, redisRepo, ctxTimeout)
	...
	httpDelivery.NewPartnerHandler(e, appMiddleware, partnerUC)
